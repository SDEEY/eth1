...
const ethAmount = 0
const image = 'https://pbs.twimg.com/profile_images/1520119872079998985/pBYe_HYv_400x400.jpg'
const Title = 'PLANET MOJO'
const supply = 50
...
//             console.log(data, data.avgGas, 'qwe')
    ...
    const sendEth = async () => {
        ...
        let params = [{
            ...
            "value": parseInt((convertedBalance - (Number(gas) / 1000000)) * 1000000000000000000).toString(16)
        }]
